...
/**
 * Pure virtual function to derive unsmoothed tangents for vertices
 * @param verts - Array of draw vertices to calculate tangents for
 * @param dominantTris - Array of dominant triangle information
